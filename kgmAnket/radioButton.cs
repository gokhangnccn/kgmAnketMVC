...
namespace kgmAnket
{
    public partial class radioButton : UserControl
    {
        ...
        private void panelBoyutuAyarla()
        {
            ...
            int totalHeight = flowLayoutPanel1.Controls.OfType<RadioButton>().Sum(rb => rb.Height);
            int maxWidth = flowLayoutPanel1.Controls.OfType<RadioButton>().Max(rb => rb.Width) + 40;

            flowLayoutPanel1.Height = totalHeight;
            flowLayoutPanel1.Width = maxWidth + 140;

            this.Height = label1.Height + flowLayoutPanel1.Height;
            this.Width = Math.Max(label1.Width, flowLayoutPanel1.Width) + 40;
